...
/**
 * For each dataset, run MIN_MIN scheduling strategy (no need to repeat for this
...
public class ExpMinminSchedule {
	...
	public static void main(String[] args) throws IOException {
		File file = new File("minmin.csv");
		BufferedWriter out = new BufferedWriter(new FileWriter(file));
		String[] models = Infrastructure.models;
		for (int repeat = 0; repeat < 30; repeat++) {
			for (String s : models) {
				Map<Integer, Integer> mapping = MinMax.minmin(MinMax.getEstTimeMatrix(s));
