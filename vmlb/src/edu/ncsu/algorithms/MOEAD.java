...
/**
 * Change crossover and mutation operator so that it can fit this problem
 * @author jianfeng
 */
...
public class MOEAD extends Algorithm {
	...
	public SolutionSet execute() throws JMException, ClassNotFoundException {
		int maxEvaluations;
		SolutionSet seedInitPopulation;
		...
		// just return the non-dominated solutions
		SolutionSet res = new NonDominatedSolutionList();
		for (int i = 0; i < population_.size(); i++)
			res.add(population_.get(i));
		return res;
	}
	...
	public void initPopulation() throws JMException, ClassNotFoundException {
		for (; population_.size() < populationSize_;) {
